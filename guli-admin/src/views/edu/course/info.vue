  ...
  <div class="app-container">
    ...
    <el-form label-width="120px">
      ...
      <el-form-item label="总课时">
        <el-input-number :min="0" v-model="courseInfo.lessonNum" size="medium" placeholder="请填写课程的总课时数" label="描述文字"/>
        <el-label style="margin-left: 8px;">小时</el-label>
      </el-form-item>

      <el-form-item label="课程价格">
        <el-input-number :min="0" v-model="courseInfo.price" size="medium" placeholder="免费课程请设置为0元"/>
      ...
      <el-form-item>
        <el-button :disabled="saveBtnDisabled" type="primary" style="margin-top: 10px;" @click="saveOrUpdate">保存并下一步</el-button>
      </el-form-item>
    </el-form>
